let item = {id:"z101",
            imgUrl:"https://melam.com/wp-content/uploads/2022/12/ambur-biriyani.jpg",
            iName:"Chicken Biriyani",
            price:399,
            qty:1
        };
...
document.getElementById('item-data').innerHTML=htmlCode;
    ...
    item.qty = storeQty;       //This updates item.qty with the value of storeQty.
